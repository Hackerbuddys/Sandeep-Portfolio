						...
						<div className="box-linear-animation position-relative z-1 p-lg-5 p-1 p-md-4">
							<div className="position-relative z-1">
								<div className="text-center">
									...
									<h3>
										Designing solutions <span className="text-300">customized<br /> to meet your requirements</span>
									</h3>
								</div>
									...
									<div className="row g-4">
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Website Design &amp; Development</h6>
												<p className="fs-7 text-300 fw-regular">Modern, responsive, and SEO-optimized websites built using <span className="text-secondary-2">Next.js,</span>, <span className="text-secondary-2"> React,</span>, <span className="text-secondary-2">JavaScript</span>, clean UI principles. Crafting fast, visually appealing web experiences that convert visitors into customers. Fast, responsive, SEO-ready websites built with Next.js and React.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Designing and integrating secure <span className="text-secondary-2">RESTful APIs</span> for smooth communication between frontend and backend systems.Ensuring scalability, performance, and reliable data flow. Delivering fast, consistent, and well-structured APIs for modern applications.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Building secure, scalable online stores with seamless <span className="text-secondary-2">product management, payments, and order systems</span> tailored to your business goals. Delivering a smooth shopping experience that boosts conversions and supports your brand’s long-term growth. Designing scalable online stores with seamless shopping and conversion-focused functionality.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Designing and managing modern databases using both SQL and NoSQL technologies such as <span className="text-secondary-2">MySQL</span>, <span className="text-secondary-2">PostgreSQL</span>, and <span className="text-secondary-2">MongoDB</span> Ensuring high performance, data integrity, and optimized storage to keep your applications running fast and efficiently.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">IT Support & Maintenance</h6>
												<p className="fs-7 text-300 fw-regular">Providing technical <span className="text-secondary-2">troubleshooting</span>, <span className="text-secondary-2">system setup,</span>optimization, and ongoing support to ensure your website or application runs smoothly. Ensuring smooth performance and quick issue resolution with reliable 24/7 technical support.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Social Media Management</h6>
												<p className="fs-7 text-300 fw-regular">Creating high-quality content, reels, branding, and posting strategies to grow online visibility and boost engagement across major platforms. Boosting online presence with strategic content, branding, and engagement growth.</p>
											</div>
										</div>
									</div>
